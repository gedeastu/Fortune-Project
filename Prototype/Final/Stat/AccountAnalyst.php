...
<html lang="en">
  ...
  <body>
    ...
    <div
      class="container max-w-full h-full bg-gradient-to-t to-[#2E3462] from-[#292E53]/100"
    >
        <!-- header -->
        <div id="header"
          class="justify-items-end grid-cols-3 grid p-10 pt-14"
        >
        ...
        <div
          ...
          class="relative bg-gradient-to-t to-[#A2A6A9]/20 from-[#466094]/20 bg-opacity-10 w-[25rem] md:w-[29rem] h-full sm:max-w-md sm:h-full px-6 rounded-2xl mx-auto border-white border-opacity-30 border shadow-lg"
        >
          <div
            id="navbar"
            class="flex  justify-around w-full h-max my-5"
          >
            <a href="ExpensivePreview.html"><img src="../img/previous.svg" alt="" class="w-3" /></a>
            <h3 class="text-white w-max my-auto text-xl font-semibold">
              Account Analysist
            </h3>
            <a href="ExpensivePreview.html"><img src="../img/next.svg" alt="" class="w-3" /></a>
          </div>

          <div id="chart" class="scale-95 md:scale-100">
            <div
              id="line_months"
              class="mx-auto grid place-items-center bg-gradient-to-t to-[#A2A6A9] from-[#466094] relative w-40 h-40 rounded-full shadow-xl"
            >
              <div
                class="bg-[#464C70] rounded-full w-32 h-32 grid place-items-center"
              >
                <div
                  id="line_weeks"
                  class="w-24 h-24 bg-gradient-to-t to-[#A2A6A9] from-[#466094] rounded-full grid place-items-center shadow-xl"
                >
                  <div
                    class="bg-white w-16 h-16 rounded-full grid place-items-center"
                  >
          ...
          <div id="totalCash" class="my-6">
            ...
            <div class="divide-x-4 flex justify-around w-full my-3 text-sm md:text-base">
          ...
          <div id="historyCash" class="gap-52 mx-auto w-full md:w-96 my-5 h-full">
            ...
            <div id="bussiness_type" class="flex grid-cols-3 gap-6 items-center my-96">
              <div id="type" class="grid-cols-2 flex gap-2">
                <div
                  id="circle_type"
                  class="w-5 h-5 rounded-full bg-white my-auto"
