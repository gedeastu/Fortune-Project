    ...
    >
        ...
        >
          ...
          >
            ...
            <a href="AccountAnalyst.html"><img src="../img/next.svg" alt="" class="w-3" /></a>
          </div>

          <div id="chart" class="w-full relative">
          <div class="flex justify-center">
          <div id="ChartBar" class="text-white scale-75 relative border mx-auto border-t-0 border-r-0 border-white md:w-[35rem] w-[18.5rem] h-[15rem]">
            ...
            <ul class="relative h-max text-right">
