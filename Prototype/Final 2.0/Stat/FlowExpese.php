  ...
  <body class="min-h-[100vh] bg-gradient-to-t to-[#2E3462] from-[#292E53]/100">
    <div id="nav_float" class="z-10 fixed w-full bottom-0">
      ...
      >
        ...
        <label for="FE_modal" class="flex items-center active:scale-90 active:transition focus:bg-[#3F49A6]/20 focus:w-max focus:h-full focus:rounded-lg focus:shadow-md focus:border focus:border-white/20 focus:p-[0.8rem]">
    ...
    >
      ...
      <div id="responsiveMode" class="md:flex md:justify-around md:gap-10 md:w-full">
      <div id="responsiveMode1" class="md:self-center md:flex md:flex-col md:gap-9 md:items-center">
        <div id="switchGraphs" class="flex items-start justify-center scale-90">
            <select name="" id="switch" class="bg-[#D0CFD8]/10 font-semibold p-3 text-center uppercase text-white border-white/20 rounded-lg">
              <option value="" class="menu">Account Analyst</option>
              <option value="" selected disabled>Flow Expese</option>
              <option value="">Overview</option>
            </select>
        </div>
        <div id="chart" class="w-full relative md:scale-110 md:self-center">
      ...
      <div id="responsiveMode2" class="md:py-1">
          <div id="historyCash" class="overflow-auto relative flex flex-col gap-9 mx-auto w-max my-5 md:w-[25rem] md:my-10 md:h-[30rem]">
    ...
    <input type="checkbox" id="FE_modal" class="modal-toggle" />
    <div class="modal">
      <div class="modal-box w-[25rem] md:w-[50rem] bg-[#2E3462]/70  border border-white border-opacity-20 filter backdrop-blur-lg text-white">
        ...
        <label for="FE_modal" class="absolute top-5 right-5 cursor-pointer active:scale-90 active:transition">
