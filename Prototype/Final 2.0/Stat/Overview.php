...
<div id="nav_float" class="z-10 fixed w-full bottom-0">
      <div class="bg-[#36669a] bg-opacity-30 border border-white border-opacity-20 filter backdrop-blur-lg w-[26rem] h-16 mx-auto flex justify-evenly rounded-3xl m-10 shadow-md" id="popUp_chat">
        ...
        <a href="../Budget/Budget.php?date=1" class="flex items-center active:scale-90 active:transition focus:bg-[#3F49A6]/20 focus:w-max focus:h-full focus:rounded-lg focus:shadow-md focus:border focus:border-white/20 focus:p-[0.8rem]">
  ...
  <div class="max-w-full">
    ...
    <div id="container_statistic" class="bg-gradient-to-t to-[#A2A6A9]/20 from-[#466094]/20 bg-opacity-10 w-[27rem] sm:w-max mx-auto h-max px-6 rounded-2xl border-white border-opacity-30 border shadow-lg">
      ...
      <!-- Paginator -->
      <form action="Paginator.php?date=<?php echo $currentMonth ?>&doc=Overview" method="post">
      ...
      <div id="responsiveMode" class="sm:grid grid grid-cols-1 sm:grid-cols-2 sm:gap-14">
        <div id="responsiveMode1" class="sm:self-center">
          <div id="switchGraphs" class="flex items-center justify-center scale-90 mt-0">

            <select name="Type" id="Type" onchange="redirectToPage()" class="bg-[#D0CFD8]/10 font-semibold p-3 text-center uppercase text-white border-white/20 rounded-lg">
          ...
          <div id="chart" class="scale-95 w-full md:scale-100 flex flex-col py-2">
            <div class="mx-auto flex sm:block items-center gap-5 relative">
              <div id="donuts_chart" class="my-auto">
                <canvas class="w-40 col-span-1" data-te-chart="doughnut" data-te-dataset-data="[12,10,12,10,5,20]" data-te-dataset-background-color="['#810CA8', '#4649FF', '#DC0000', '#FF7000', '#C539B4', '#6C4AB6']">
                </canvas>
              </div>
        ...
        <div id="responsiveMode2" class="sm:self-center">
          ...
          <div id="historyCash" class="gap-9 mx-auto w-full overflow-auto md:h-[25rem] md:w-96 my-5 md:my-14 flex flex-col text-white">
            <div id="itemHistory" class="flex w-full justify-around">
              <div id="icon" class="w-10">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-full fill-current m-auto" viewBox="0 0 384 512">
              ...
              <div id="decs" class="self-center flex flex-col">
                <div id="heading">
                  <p class="text-lg font-semibold">Coupon</p>
                </div>
            ...
            <div id="itemHistory" class="flex w-full justify-around">
              <div id="icon" class="w-10">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-full fill-current m-auto" viewBox="0 0 576 512">
                  <path d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z" />
                </svg>
              </div>
              <div id="decs" class="self-center flex flex-col">
                <div id="heading">
                <p class="text-lg font-semibold">Family</p>
                </div>
                <div id="parameter" class="border border-white w-44 h-3">
                  <div id="meter" class="bg-white w-1/2 h-full"></div>
                </div>
            ...
            <div id="itemHistory" class="flex w-full justify-around">
              ...
              <div id="decs" class="self-center flex flex-col">
                <div id="heading">
                <p class="text-lg font-semibold">Retirement</p>
                </div>
                <div id="parameter" class="border border-white w-44 h-3">
                  <div id="meter" class="bg-white w-1/2 h-full"></div>
                </div>
            ...
            <div id="itemHistory" class="flex w-full justify-around">
              <div id="icon" class="w-10">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-full fill-current m-auto" viewBox="0 0 640 512">
              ...
              <div id="decs" class="self-center">
                <div id="heading">
                <p class="text-lg font-semibold">Entertainment</p>
                </div>
                <div id="parameter" class="border border-white w-44 h-3">
                  <div id="meter" class="bg-white w-1/2 h-full"></div>
                </div>
            ...
            <div id="itemHistory" class="flex w-full justify-around">
              ...
              <div id="decs" class="self-center">
                <div id="heading">
                <p class="text-lg font-semibold">Investment</p>
                </div>
                <div id="parameter" class="border border-white w-44 h-3">
                  <div id="meter" class="bg-white w-1/2 h-full"></div>
                </div>
            ...
            <div id="itemHistory" class="flex w-full justify-around">
              ...
              <div id="decs" class="self-center">
                <div id="heading">
                <p class="text-lg font-semibold">Award</p>
                </div>
                <div id="parameter" class="border border-white w-44 h-3">
                  <div id="meter" class="bg-white w-1/2 h-full"></div>
                </div>
