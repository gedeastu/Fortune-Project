...
<head>
  ...
  <!-- title -->
  <title>Fortune - Expenses Edit</title>
</head>
        ...
        <div id="field_income" class="mt-5 max-w-3xl">
          <div id="responsive_income" class="md:grid-cols-2 md:grid md:h-full md:relative md:items-center md:gap-5">
            <div id="responsive1" class="md:w-full md:h-96">
              ...
              <!-- Form Start- -->
              <form action="Edit/Expands.php?id=<?php echo $ID ?>" method="post">
                <!-- Title Income -->
                ...
                <div id="Category" class="w-full relative bg-white/10 rounded-xl pb-3">
                  <div id="titleCategory" class="h-max mb-3 text-white">
                    <h3 class="h-full mx-auto w-max font-semibold pt-2">Category</h3>
                  </div>
                  ...
                  <div id="trackCategory" class="mx-5 border border-white/20 h-28 overflow-y-auto relative shadow-inner rounded-lg">
                    ...
                    <div id="pocket_category" class="flex w-full overflow-hidden">
                      <input name="Category" value="11" id="pocket" type="radio" class="hidden" <?php if ($takeCategory["Id_Category"] == '11') {echo "checked";} ?>>
                      <label for="pocket" class="cursor-pointer flex w-full p-3 bg-white/25 text-white border border-white/10 overflow-hidden" data-tippy-content="Shoping">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 fill-current m-auto" viewBox="0 0 576 512"><style>svg{fill:#ffffff}</style><path d="M253.3 35.1c6.1-11.8 1.5-26.3-10.2-32.4s-26.3-1.5-32.4 10.2L117.6 192H32c-17.7 0-32 14.3-32 32s14.3 32 32 32L83.9 463.5C91 492 116.6 512 146 512H430c29.4 0 55-20 62.1-48.5L544 256c17.7 0 32-14.3 32-32s-14.3-32-32-32H458.4L365.3 12.9C359.2 1.2 344.7-3.4 332.9 2.7s-16.3 20.6-10.2 32.4L404.3 192H171.7L253.3 35.1zM192 304v96c0 8.8-7.2 16-16 16s-16-7.2-16-16V304c0-8.8 7.2-16 16-16s16 7.2 16 16zm96-16c8.8 0 16 7.2 16 16v96c0 8.8-7.2 16-16 16s-16-7.2-16-16V304c0-8.8 7.2-16 16-16zm128 16v96c0 8.8-7.2 16-16 16s-16-7.2-16-16V304c0-8.8 7.2-16 16-16s16 7.2 16 16z"/></svg>
                      </label>
                    </div>

                    <div id="bonus_category" class="flex w-full overflow-hidden">
                      <input name="Category" value="8" id="bonus" type="radio" class="hidden" <?php if ($takeCategory["Id_Category"] == '8') {echo "checked";} ?>>
                      <label for="bonus" class="cursor-pointer flex w-full p-3 bg-white/25 text-white border border-white/10 overflow-hidden" data-tippy-content="Entertaiment">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 fill-current m-auto" viewBox="0 0 640 512">
                    ...
                    <div id="Investment_category" class="flex w-full overflow-hidden">
                      <input name="Category" value="9" id="investment" type="radio" class="hidden" <?php if ($takeCategory["Id_Category"] == '9') {echo "checked";} ?>>
                      <label for="investment" class="cursor-pointer flex w-full p-3 bg-white/25 text-white border border-white/10 overflow-hidden" data-tippy-content="Food">
                        <svg xmlns="http://www.w3.org/2000/svg\" class="w-12 fill-current m-auto" viewBox="0 0 512 512"><style>svg{fill:#ffffff}</style><path d="M88 0C74.7 0 64 10.7 64 24c0 38.9 23.4 59.4 39.1 73.1l1.1 1C120.5 112.3 128 119.9 128 136c0 13.3 10.7 24 24 24s24-10.7 24-24c0-38.9-23.4-59.4-39.1-73.1l-1.1-1C119.5 47.7 112 40.1 112 24c0-13.3-10.7-24-24-24zM32 192c-17.7 0-32 14.3-32 32V416c0 53 43 96 96 96H288c53 0 96-43 96-96h16c61.9 0 112-50.1 112-112s-50.1-112-112-112H352 32zm352 64h16c26.5 0 48 21.5 48 48s-21.5 48-48 48H384V256zM224 24c0-13.3-10.7-24-24-24s-24 10.7-24 24c0 38.9 23.4 59.4 39.1 73.1l1.1 1C232.5 112.3 240 119.9 240 136c0 13.3 10.7 24 24 24s24-10.7 24-24c0-38.9-23.4-59.4-39.1-73.1l-1.1-1C231.5 47.7 224 40.1 224 24z"/></svg>
                      </label>
                    </div>

                    <div id="online_category" class="flex w-full overflow-hidden">
                      <input name="Category" value="10" id="online" type="radio" class="hidden" <?php if ($takeCategory["Id_Category"] == '10') {echo "checked";} ?>>
                      <label for="online" class="cursor-pointer flex w-full p-3 bg-white/25 text-white border border-white/10 overflow-hidden" data-tippy-content="Insurance">
                    ...
                    <div id="category_02" class="flex w-full ">
                      ...
                      <div id="edu_category" class="flex w-1/4 overflow-hidden">
                        <input type="radio" name="Category" value="12" class="hidden" id="edu" <?php if ($takeCategory["Id_Category"] == '12') {echo "checked";} ?>>
                        <label for="edu" class="cursor-pointer flex w-full p-3 bg-white/25 text-white border border-white/10 overflow-hidden" data-tippy-content="Credit Card">
                          <svg xmlns="http://www.w3.org/2000/svg" class="w-10 fill-current m-auto" viewBox="0 0 576 512"><path d="M64 32C28.7 32 0 60.7 0 96v32H576V96c0-35.3-28.7-64-64-64H64zM576 224H0V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V224zM112 352h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm112 16c0-8.8 7.2-16 16-16H368c8.8 0 16 7.2 16 16s-7.2 16-16 16H240c-8.8 0-16-7.2-16-16z"/></svg>
                        </label>
                      </div>
                ...
                <div id="AccDate" class="flex justify-between my-3 gap-2.5 ">
                  ...
                  <div id="Account" class="w-52 relative bg-white/10 rounded-xl pb-3">
                    <div id="titleAccount" class="h-max text-white">
                      <h3 class="h-full font-semibold w-max mx-auto py-1">Account</h3>
                    </div>
                  ...
                  <img src="../img/calendar.svg" alt="" class="w-4">
                    ...
                    <div id="titleDate" class="mx-auto text-center text-white pt-1 font-semibold">
                      <h2>Date</h2>
                    </div>
                    <input name="iDate" type="date" id="datepicker" class="bg-transparent border-none mx-auto text-white placeholder-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-max p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" value="<?php echo $history["Date"] ?>">
                    <style>
  ...
  <div class="modal">
    <div class="modal-box w-[25rem] md:w-[50rem] bg-[#2E3462]/70  border border-white border-opacity-20 filter backdrop-blur-lg text-white">
      ...
      <div class="modal-action w-full">
        ...
        <label for="delete" class="btn bg-blue-600 text-white w-1/2 border-none">No</label>
      </div>
    </div>
  </div>
  <!--Tippy JS -->
