...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($checkBudgetQuery) === 1) {
        ...
        mysqli_query($conn, "UPDATE History SET Id_Wallet = '$id_wallet', Id_Budget = '$Budget', Title = '$title', Type = 'Income', Amount = '$Amount', Description = '$Description', Date = '$cDate' WHERE Id_History = $ID");
        // mysqli_query($conn, "INSERT INTO History (Id_Wallet, Id_Budget, Title, Type, Amount, Description, Date) VALUES ('$id_wallet', '$Budget', '$title', 'Income', '$Amount', '$Description', '$cDate')");
