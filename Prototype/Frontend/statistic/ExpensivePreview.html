  ...
  <body>
    ...
    >
        ...
        >
          ...
          >
            <a href="AccountAnalyst.html"><img src="../img/previous.svg" alt="" class="w-3" /></a>
            <h3 class="text-white w-max my-auto text-xl font-semibold">
              Expensive Preview
            </h3>
            <a href="chartBatang.html"><img src="../img/next.svg" alt="" class="w-3" /></a>
          </div>

          <div id="chart" class="">
            <div class="mx-auto w-40 overflow-hidden">
                <canvas
                  data-te-chart="pie"
                  data-te-dataset-label="Hello World"
                  data-te-dataset-data="[2112, 2343, 2545, 3423, 2365, 1985, 987]"
                  data-te-dataset-background-color="['#3F49A6','']">
                </canvas>
              </div>
          </div>
