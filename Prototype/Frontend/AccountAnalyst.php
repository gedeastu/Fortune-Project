  ...
  <body class="min-h-[100vh] bg-gradient-to-t to-[#2E3462] from-[#292E53]/100">
    ...
    <div
      class="container max-w-full">
        ...
        <div id="container_statistic" class="relative bg-gradient-to-t to-[#A2A6A9]/20 h-full from-[#466094]/20 bg-opacity-10 w-[27rem] md:w-max px-6 rounded-2xl mx-auto border-white border-opacity-30 border shadow-lg">
        <div id="navbar" class="flex items-center justify-center mx-auto h-max my-5">
            <a href="DonutsChart.html"><img src="../img/previous.svg" alt="" class="w-3" /></a>
            <h3 class="text-white text-xl font-semibold min-w-[15rem] text-center">
              Account Analyst
            </h3>
            <a href="chartBatang.php"><img src="../img/next.svg" alt="" class="w-3" /></a>
        </div>

          <div id="responsiveMode" class="md:flex md:justify-around md:gap-10 md:h-full md:w-full">
          <div id="responsiveMode1" class="md:h-1/2 md:self-center md:flex md:flex-col md:gap-10 md:items-center">
          ...
          <div id="historyCash" class="gap-9 mx-auto w-max md:w-[25rem] my-5 md:h-[35rem] overflow-auto relative flex flex-col">
